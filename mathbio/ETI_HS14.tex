...
$N'(t) = (e^{c t} \cdot N_0)' = c\cdot(e^{c t} \cdot N_0) = c \cdot N(t)$ \checkmark
...
$(\frac{x(t)}{e^{rt}})' = (e^{-rt} \cdot x(t))' = (e^{-rt})' \cdot x(t) + e^{-rt} \cdot (x(t))' = -r\cdot e^{-rt} \cdot x(t) + e^{-rt} x'(t) = -r\cdot e^{-rt} \cdot x(t) + e^{-rt} \cdot r\cdot x(t) = 0$
...
Ein relativer Gewichtsunterschied von $\sim 2\%$ eines in einer ruhender Hand gehaltenen Gegenstands wird erkannt. D.h. bei $50$gr eine Gewichtsunterschied von $1$gr.
